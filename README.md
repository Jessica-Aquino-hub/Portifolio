...
O **Projeto Portfólio** é um **site profissional moderno**, desenvolvido com **HTML, CSS e JavaScript**, com o objetivo de apresentar informações sobre a pessoa desenvolvedora, seus projetos e formas de contato de maneira clara, interativa e responsiva.
...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/Jessica-Aquino-hub/Portifolio.git
   ```
...
🔗 https://github.com/Jessica-Aquino-hub/Portifolio.git
------
